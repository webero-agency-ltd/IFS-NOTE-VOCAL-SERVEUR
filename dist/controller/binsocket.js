...
module.exports = function (server, db) {
    ...
    binsocket.on('connection', function (client) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, md5, type, typeId, contactId, nameFile, pathFile, fileWriter;
            return __generator(this, function (_b) {
                _a = require('url').parse("http://bin.fr/so/" + client._socket.upgradeReq.url, true).query, md5 = _a.md5, type = _a.type, typeId = _a.typeId, contactId = _a.contactId;
