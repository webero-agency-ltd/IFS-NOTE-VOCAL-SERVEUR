...
db.sequelize.sync({ force: false })
    ...
    db.User.findOne({
        ...
        return __awaiter(this, void 0, void 0, function () {
            var full_name, email, role, password;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        role = 'admin';
                        return [4 /*yield*/, hash_1.default('admin@gmail.com')];
                    case 1:
                        password = _a.sent();
                        User.create({ full_name: full_name, email: email, password: password, role: role })
                            .then(function (user) {
...
var Serveur = /** @class */ (function () {
    ...
    Serveur.prototype.middleware = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cbl = require('./middleware/index');
                        return [4 /*yield*/, cbl(app, db)];
                    case 1:
                        middleware = _a.sent();
                        return [2 /*return*/];
                }
    ...
    Serveur.prototype.route = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, require('./route/index')(app, db)];
                    case 1:
                        route = _a.sent();
                        if (env == 'local') {
                            ...
                            server = https.createServer(options, app).listen(this.port, function () {
                                console.log('le serveur prod sur le port', _this.port);
                            });
                        }
                        this.socket(server);
                        return [2 /*return*/];
