...
var actions = (_a = {},
    ...
    _a['ADD_APPLICATION'] = function (_a) {
        var commit = _a.commit, state = _a.state;
        return __awaiter(this, void 0, void 0, function () {
            var compteId, name, type, body, _b, err, data, win;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _b = _c.sent(), err = _b[0], data = _b[1].data;
                        if (err) {
                            commit('generale/ERROR', { message: lang_1.default('G0001') }, { root: true });
                        }
...
var mutations = (_b = {
    ...
    _b['ADD_APPLICATION'] = function (state, data) {
        state.rows = data.concat(state.rows);
    },
    _b);
var getters = {
