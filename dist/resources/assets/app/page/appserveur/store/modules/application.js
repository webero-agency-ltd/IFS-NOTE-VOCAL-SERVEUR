...
var actions = (_a = {},
    ...
    _a['ADD_APPLICATION'] = function (_a, _b) {
        var commit = _a.commit, state = _a.state;
        var namespace = _b.namespace;
        return __awaiter(this, void 0, void 0, function () {
            var compteId, name, type, body, _c, err, data, win;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        compteId = state.compteId, name = state.name, type = state.type;
                        body = {};
                        if (name && compteId) {
    ...
    _a['RE_AUTHORIZE'] = function (_a, _b) {
        var commit = _a.commit, state = _a.state;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, api_1.default("/application/reauthorize/all/" + id)];
                    case 1:
                        _c = _d.sent(), err = _c[0], data = _c[1].data;
                        if (err) {
                            return [2 /*return*/, commit(namespace + '/ERROR', { message: err.message }, { root: true })];
    ...
    _a['ITEM_APPLICATION'] = function (_a, _b) {
        var commit = _a.commit, state = _a.state;
        var namespace = _b.namespace, id = _b.id;
        return __awaiter(this, void 0, void 0, function () {
            var _c, err, data;
...
var mutations = (_b = {
    ...
    _b['ADD_APPLICATION'] = function (state, data) {
        console.log(data);
        state.rows = data.slice();
    },
    _b['ADD_ITEM'] = function (state, data) {
        state.item = Object.assign({}, __assign({}, data));
    },
    _b);
var getters = (_c = {
        getField: vuex_map_fields_1.getField
    },
    _c['rowsTrello'] = function (state, data) {
        return state.rows.filter(function (e) { return e.type === 'trello'; });
    },
    _c['rowsIFS'] = function (state, data) {
        return state.rows.filter(function (e) { return e.type === 'infusionsoft'; });
    },
    _c);
