...
var actions = (_a = {},
    ...
    _a['ALL_TEAM'] = function (_a, op) {
        var commit = _a.commit, state = _a.state;
        return __awaiter(this, void 0, void 0, function () {
            var _b, err, data, items;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, api_1.default('/team/application/' + op)];
                    case 1:
                        _b = _c.sent(), err = _b[0], data = _b[1].data;
                        if (err) {
                            commit('generale/ERROR', { message: err.message }, { root: true });
                        }
                        items = data.map(function (_a) {
                            var id = _a.id, fullname = _a.fullname, email = _a.email, role = _a.role;
    ...
    _a['MEMBRE_TRELLO'] = function (_a, op) {
        var commit = _a.commit, state = _a.state;
        return __awaiter(this, void 0, void 0, function () {
            var _b, err, data, items;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, api_1.default('/trello/membre/' + op)];
                    case 1:
                        _b = _c.sent(), err = _b[0], data = _b[1].data;
                        if (err) {
                            commit('generale/ERROR', { message: err.message }, { root: true });
    ...
    _a['MEMBRE_INFUSIONSOFT'] = function (_a, op) {
        var commit = _a.commit, state = _a.state;
        return __awaiter(this, void 0, void 0, function () {
            var _b, err, data, items;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, api_1.default('/infusionsoft/membre/' + op)];
                    case 1:
                        _b = _c.sent(), err = _b[0], data = _b[1].data;
                        if (err) {
                            commit('generale/ERROR', { message: err.message }, { root: true });
...
var mutations = (_b = {
    ...
    _b['ALL_TEAM'] = function (state, data) {
        state.teams = data.concat(state.teams);
    },
    _b['MEMBRE_TRELLO'] = function (state, data) {
        state.membreTrello = data.concat(state.membreTrello);
    },
    _b['MEMBRE_INFUSIONSOFT'] = function (state, data) {
        state.membreInfusionsoft = data.concat(state.membreInfusionsoft);
    },
    _b);
var getters = {
