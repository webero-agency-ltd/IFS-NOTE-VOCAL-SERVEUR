    ...
    exoption.prototype.findOption = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, api_1.default('/external')];
                    case 1:
                        _a = _b.sent(), err = _a[0], data = _a[1].data;
                        if (err)
                            return [2 /*return*/, [err, null]];
                        this.stade.external = Object.assign({}, __assign({}, data));
                        return [2 /*return*/, [null, this.stade.external]];
                }
            });
        });
    };
    exoption.prototype.createOption = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, err, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, api_1.default('/external', 'POST', body)];
                    case 1:
                        _a = _b.sent(), err = _a[0], data = _a[1].data;
                        if (err)
                            return [2 /*return*/, [err, null]];
                        return [2 /*return*/, this.findOption()];
                }
            });
        });
    };
