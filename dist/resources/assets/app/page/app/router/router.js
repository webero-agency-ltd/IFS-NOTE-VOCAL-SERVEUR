...
var serveur_1 = __importDefault(require("../page/serveur"));
var installsite_1 = __importDefault(require("../page/installsite"));
...
var router = new vue_router_1.default({
    routes: [
        ...
        { name: 'seveur', path: '/seveur', component: serveur_1.default },
        { name: 'installsite', path: '/site', component: installsite_1.default },
