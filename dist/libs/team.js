...
var teal = /** @class */ (function () {
    ...
    */
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, promise_1.default(u.getTeams())];
                    case 2:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        T = data;
                        return [4 /*yield*/, promise_1.default(T.update(obj))];
                    case 2:
                        _a = _c.sent(), err = _a[0], data = _a[1];
                        return [2 /*return*/, data];
                }
     ...
     * Création d'un team
    */
    teal.prototype.create = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            var Team, _a, err, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        Team = global['db'].Team;
                        return [4 /*yield*/, promise_1.default(Team.create(__assign({ role: 'admin' }, obj)))];
                    case 1:
                        _a = _b.sent(), err = _a[0], data = _a[1];
                        if (err)
                            return [2 /*return*/, null];
